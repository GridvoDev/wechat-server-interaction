...
Service.prototype.getSuiteAuthURL = function (suiteID, callback) {
    ...
    async.waterfall([function (cb) {
        var GRIDVO_WECHAT_SERVICE_HOST = process.env.GRIDVO_WECHAT_SERVICE_HOST ? process.env.GRIDVO_WECHAT_SERVICE_HOST : "127.0.0.1";
        var GRIDVO_WECHAT_SERVICE_PORT = process.env.GRIDVO_WECHAT_SERVICE_PORT ? process.env.GRIDVO_WECHAT_SERVICE_PORT : "80";
        ...
        if (body && body.suiteAuthUrl && body.errcode == "200" && body.errmsg == "ok") {
            callback(null, body.suiteAuthUrl);
        }
        else {
            callback(null, null);
        }
